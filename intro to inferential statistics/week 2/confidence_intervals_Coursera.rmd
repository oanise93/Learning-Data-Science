...
```{r set-seed}
set.seed(726)                 # make sure to change the seed
```
...
# type your code for the Exercise here, and Knit
capture = params > 1338.891 && params < 1632.309 
```
...
98%; This is greater than we expected, but since we took a sample of 50 the confidence level would have had to be greater or lower. 
We couldn't have reached exactly 95%. Ultimately, this is just because of the random sample that we got.
</div>
