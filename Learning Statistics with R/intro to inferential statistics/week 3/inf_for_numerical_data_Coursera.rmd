...
<div id="exercise">
**Exercise**: What is the conclusion of the hypothesis test? With a p-value of .0199 we can reject the null hypothesis and say that the difference observed between the weights of mothers who smoked and those who didn't is statistically signficant.
</div>
...
The width is larger for the 99% confidence than the 90% confidence level.
</div>
```{r weeks-ci-90}
...
```{r gained-mature-ht}
# type your code for the Exercise here, and Knit
inference(y = weeks, x = mature, data = nc, statistic = "mean", type = "ht",
          null = 0, alternative = "twosided", method="theoretical", order = c("mature mom", "younger mom"))
```
...
```{r pick-your-own}
# type your code for the Exercise here, and Knit
inference(y = visits, x = mature, data = nc, statistic = "mean", type = "ht",
          null = 0, alternative = "twosided", method = "theoretical", order = c("mature mom", "younger mom"))
```
